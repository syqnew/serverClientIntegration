define(
		[ 'app', 'jquery', 'underscore', 'backbone', 'Handlebars', 'text!templates/student.template',
				'text!templates/timer.template', 'text!templates/openOrders.template', 'text!templates/news.template',
				'text!templates/quotePortfolioTable.template', 'text!templates/cancelOrder.template', '../news',
				'../updateTable', '../volumeGraph', '../flotGraph', '../trading', 'flot', 'flotTime', 'flotSymbol',
				'bootstrap' ],
		function(App, $, _, Backbone, Handlebars, studentTemplate, timerTemplate, openOrdersTemplate, newsTemplate, quotePortfolioTableTemplate, cancelOrderTemplate) {
